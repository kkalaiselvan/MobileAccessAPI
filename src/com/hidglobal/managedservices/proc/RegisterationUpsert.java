...
public class RegisterationUpsert extends StoredProcedure {

	private static final String STORED_PROC_NAME="ma_callback_utils.register_callback_url";
	
	public RegisterationUpsert(DataSource ds) {
		...
		declareParameter(new SqlOutParameter("po_registration_id", Types.NUMERIC));
